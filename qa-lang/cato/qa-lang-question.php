...
*/
	...
	return array(
		...
		'a_convert_to_c_on' => 'Convert this reaction into a comment on:',
		'a_convert_to_c' => 'Convert this reaction into a comment',
		'a_convert_warn_cs' => 'Warning: This conversion cannot be reversed and will also move this reaction\'s comments.',
		'a_convert_warn' => 'Warning: This conversion cannot be reversed.',
		'a_notify_email' => 'Email me at this address if my reaction is selected or commented on:',
		'a_notify_label' => 'Email me if my reaction is selected or commented on',
		'a_notify_x_label' => 'Email me (^) if my reaction is selected or commented on',
		...
		'add_answer_button' => 'Post a reaction',
		'add_comment_button' => 'Post a comment', 
		...
		'comment_a_popup' => 'Add a comment',
		'comment_button' => 'Write a comment',
		...
		'q_content_label' => 'Explain the action you want to add here. It is important that you address the following items in the description of the action: Action description (short description of the action), Why (why is it important to take action?), What should be the result (describe the anticipated result of the action), Who and when (describe who should initiate the action and when the first steps should be taken)',
		...
		'q_notify_email' => 'Email me at this address if there is a reaction on my action or if there is a comment on my reaction:',
		'q_notify_label' => 'Email me if there is a reaction on my action or if there is a comment on my reaction',
		'q_notify_x_label' => 'Email me (^) if there is a reaction on my action or if there is a comment on my reaction',
		...
		'your_comment_a' => 'Your comment on this reaction:',
		'your_comment_q' => 'Your comment on this action:',
	);
