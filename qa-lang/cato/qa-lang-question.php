...
*/
	...
	return array(
		...
		'add_comment_button' => 'Write a comment', 
		...
		'q_content_label' => 'Explain your action here. It is import when you write your action to address the following issues: (1) What should be the result of the action? (2) Who should take action (actor) and what should be the first steps?',
